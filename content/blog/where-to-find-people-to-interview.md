---
title: "Where to Find People to Interview for Your Startup Idea"
description: "No network, no company email, just a high schooler with an idea. Here is where to find people to interview for customer discovery from scratch."
date: "2026-02-07"
updated: "2026-02-07"
category: "Validate"
author: "rishabh"
tags: ["customer discovery", "finding interviewees", "cold outreach", "reddit", "teen entrepreneurship"]
---
...
Bad: "Students who are stressed."
Good: "Juniors at my school taking three or more AP classes who feel behind on college apps."

The narrower this sentence is, the easier every step after becomes, because you'll instantly recognize the right person when you see them. If you're still fuzzy on who has the problem, back up first and read our guide on [how to find a startup problem worth solving](/blog/how-to-find-a-startup-problem-worth-solving) before you spend a single message.

One more thing: you are interviewing to learn, not to sell. If you go in trying to convince people your idea is great, they'll be polite and lie to you. Read [the Mom Test](/blog/mom-test-for-teen-founders) before your first call so you ask questions that get honest answers instead of fake compliments.
...
1. **Lead with why them.** Reference the exact post, comment, or detail that made you reach out. "I saw your comment about hating group project scheduling."
2. **Say who you are in one line.** "I'm a high school student researching this problem." Being a student is an advantage, not something to hide. People help students.
3. **Make a tiny ask.** Not "can I interview you." Ask for "10 minutes to hear about your experience." Small requests get big yes rates.
4. **Do not pitch your idea.** You're there to learn about their problem, not describe your solution.
5. **Make it effortless to say yes.** Offer a couple of specific times, or offer to just chat over text if a call feels like too much.
...
Send ten of these. Expect two or three replies. That's a normal, healthy response rate, and it's plenty. If you want to sharpen the writing itself, we have full guides on [how to cold DM strangers without being annoying](/blog/how-to-cold-dm-people-without-being-annoying) and [how to write a cold email that actually gets replies](/blog/how-to-write-a-cold-email-that-gets-replies).
...
We wrote a whole guide for exactly this situation: [validating an idea when you can't talk to strangers yet](/blog/validate-idea-parents-wont-let-you). And if talking to anyone at all makes your stomach drop, that's normal too. Read [how to talk to customers when you're shy or nervous](/blog/talk-to-customers-when-shy) and start with text-based conversations instead of calls.
...
That's enough to know whether you're onto something real or talking yourself into an idea nobody actually wants. For the full breakdown, see [how many customer interviews you actually need](/blog/how-many-customer-interviews-are-enough).
