...
The entire game of paid ads is simple: **LTV has to be bigger than CAC**, ideally by a lot. If you can't say what those two numbers are, you're not ready to run ads. You're gambling. Our guide to [unit economics, explained simply](/blog/unit-economics-explained-simply) walks through these numbers with real examples if they feel fuzzy.
...
1. People who find you on their own actually sign up or buy. If you don't have that yet, read [how to build a landing page that converts](/blog/build-landing-page-that-converts) first — that's the leak you have to plug.
2. You know roughly what a customer is worth (your LTV), so you know what you can afford to pay to get one.
3. Your product isn't free with no upgrade. If nobody pays you anything, there's no CAC math that ever works.

There's also the money reality. A teen budget might be $30 from a part-time job or birthday cash. Meta needs several days and a few dozen dollars just to "learn" who to show your ad to before it performs. You can burn your whole budget in the platform's warm-up phase and never reach the part where ads get efficient. Free channels don't have that tax. Before spending a cent, work through [distribution: how early startups actually find users](/blog/distribution-channels-for-early-startups) and pick one free channel to go deep on.
...
- You've gotten your [first 10 customers](/blog/how-to-get-first-10-customers-student-founder) without ads. That proves the product converts and people will pay.
...
Notice the pattern: ads are for **scaling something that works**, not discovering whether anything works. If you're still figuring out who your customer is or what to say, that's validation and messaging work. Do it for free. [Positioning: how to make people care about your product](/blog/positioning-for-first-time-founders) is where that message gets built.
...
Each of these has a full playbook: [getting your first users from TikTok](/blog/get-users-from-tiktok-as-a-founder), [launching on Reddit without getting banned](/blog/how-to-launch-on-reddit-without-getting-banned), and the counterintuitive-but-true [why you should pick one marketing channel, not ten](/blog/one-channel-vs-many-early-growth). Pick one. Go deep. That focus beats a scattered ad budget almost every time.
