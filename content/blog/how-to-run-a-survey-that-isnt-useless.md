---
title: "How to Run a Survey That Actually Tells You Something"
description: "Most startup surveys produce garbage data. Here is how to run a survey that gives real signal instead of the answers people think you want."
date: "2026-02-11"
updated: "2026-09-14"
category: "Validate"
author: "rishabh"
tags: ["surveys", "validation", "survey questions", "customer research", "biased data"]
---
...
So run [customer interviews](/blog/customer-interviews-beginners-guide) first. Talk to eight or ten people, let them surprise you, and figure out the real shape of the problem in their words. Once you've heard the same complaint three times and you want to know how common it is, then a survey earns its place. The rule of thumb: interviews tell you *what* questions to ask, surveys tell you *how many people* would answer them the same way.

If you're still at the "is this even a real problem" stage, you're not ready for a survey. Start with [how to validate a startup idea in high school](/blog/how-to-validate-startup-idea-high-school) instead.
...
The same disease behind bad interviews infects bad surveys: people lie to be kind. The fix is the same too. The [Mom Test](/blog/mom-test-for-teen-founders) rule — ask about real, past behavior instead of your idea — works just as well on a form as it does in a conversation. And if your evidence so far is that your friends said they love it, read [why "my friends love it" is not validation](/blog/friends-family-said-they-loved-my-idea), because a survey of those same friends is just that trap with a spreadsheet attached.
...
- Post in communities where your customer already hangs out — a subreddit for the hobby, a Discord server for the class, a Facebook group parents use. More on that in [how to find where your customers already hang out online](/blog/how-to-find-where-your-customers-hang-out).
- If you're stuck talking only to people you know, [where to find people to interview](/blog/where-to-find-people-to-interview) applies to survey respondents too.
...
One warning: do not chase a big number for its own sake. Thirty honest responses from real customers beat 200 from classmates who'll never buy. If you want to think clearly about how many responses is "enough," the logic in [how many customer interviews do you actually need](/blog/how-many-customer-interviews-are-enough) carries straight over to surveys.
