...
1. **Write the words first, in a plain doc.** Before you open Canva, type out what goes on each slide as bullet points. Design is way faster when you're not also inventing the content. If you don't know what slides you need, use our [pitch deck slide order that works](/blog/pitch-deck-slide-order-that-works) as your outline.
...
5. **Delete slides you don't need** and duplicate the ones you do. A first-round deck is usually 10-12 slides. See [how many slides a pitch deck should have](/blog/how-many-slides-in-a-pitch-deck) if you're unsure.
...
Then customize just enough that it's not obviously a stock template. Change the accent color to something that matches your product, swap in your own photos, and use your real logo. Five minutes of that makes a $0 deck look bespoke. This matters more than people think — a clean, specific deck is part of how you [make people care about your product](/blog/positioning-for-first-time-founders), not just look at it.
...
- **Market:** Who else has this problem. Be honest about size — read [how to size your market without faking a huge number](/blog/pitch-deck-market-size-slide) before you write anything with a dollar sign.
- **Traction:** Even with no revenue, you have something. "82 items posted, 31 reunited, 3 schools asked to use it." Here's [what to put on your traction slide when you have no revenue](/blog/traction-slide-with-no-revenue).
...
Do those six things and your free deck will look better than plenty of paid ones. Then rehearse — because a beautiful deck read by a nervous founder still loses. Walk through [how to rehearse a pitch so it sounds natural](/blog/how-to-rehearse-a-pitch) and get clear on the [difference between the deck and the pitch itself](/blog/pitch-deck-vs-pitch-difference), because they are not the same thing.
