...
category: "Market"
author: "team"
tags: ["go to market", "GTM", "marketing plan", "distribution", "launch"]
---
...
3. **Write one message.** In a single sentence, say what your product does and why this specific person would want it. Skip adjectives. "Helps you X so you can Y" beats "the ultimate all-in-one platform" every time. This is where [positioning](/blog/positioning-for-first-time-founders) does the heavy lifting.
...
Notice it doesn't mention paid ads, an email list, or a launch on Product Hunt. Those can come later. The plan does exactly one thing well. Once you have your first users, the next problem is turning them into more, which is its own skill. Read [how to get your first 10 customers](/blog/how-to-get-first-10-customers-student-founder) for that stage.
...
- **Talking to no one before writing the message.** If you haven't done a few [customer interviews](/blog/customer-interviews-beginners-guide), your message is a guess. Guessed messages usually miss.
...
- **Skipping the competitor check.** You should know what your audience uses today, even if it's a spreadsheet or a notebook. A quick [competitive analysis](/blog/how-to-do-competitive-analysis) tells you what to say differently.
