...
5. **Local pitch competitions.** Your city's chamber of commerce, a local incubator, or a nearby university may run a youth pitch contest with a scholarship prize. Local means way less competition. Our guide on [national vs. local startup competitions](/blog/national-vs-local-startup-competitions) explains why "local" is often the smarter bet.
...
You do not have to pick one. The same startup story can be reshaped to fit an essay one week and a pitch the next. Write the core version once, then adapt it. If you have never pitched before, [how to pitch a startup idea as a teenager](/blog/how-to-pitch-startup-idea-as-a-teenager) walks you through the basics so a recorded submission is not terrifying.
...
- **Show the action you took.** Did you interview people? Build a landing page? Charge someone? Name the exact steps. If you ran real conversations, mention it, and if you have not yet, [customer interviews for beginners](/blog/customer-interviews-beginners-guide) shows you how so you have something concrete to write about.
...
- **End with what you learned.** The best scholarship essays are not victory laps. They show growth. Even a failure works if you show what it taught you. Our post on [what to do when your first startup fails](/blog/dealing-with-failure-as-a-young-founder) has language you can borrow for exactly this.

You do not need a company that made thousands of dollars. A student who spent $20 on a domain, sold handmade phone grips to classmates, and learned unit economics the hard way is a better story than a vague "I want to be an entrepreneur" essay. If you are unsure whether your side project counts, it almost certainly does, and [why you should start a company in high school](/blog/why-start-a-company-in-high-school) makes the case for taking even a small one seriously.
...
It does, and that is the quiet bonus here. The same startup that wins entrepreneurship scholarships also strengthens your main application. It gives you a distinct, concrete thing to write about while other applicants recycle the same clubs. We break this down in [does entrepreneurship help with college applications](/blog/entrepreneurship-extracurricular-college-apps), and if you want the tactical version, [how to write about your startup on college applications](/blog/should-you-put-your-startup-on-your-college-application) shows you how to describe it without sounding like you are exaggerating.
...
3. **This month:** If you do not have a business yet, start the smallest possible one, or [apply to a program](/apply) that will walk you through building one from scratch.
