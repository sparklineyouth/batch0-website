...
category: "Playbook"
author: "team"
tags: ["national startup competitions", "local competitions", "competition strategy", "prize odds", "where to compete"]
---
...
1. **Enter 2–3 local or school-level contests** to learn the format and collect a first win or two. Your school's DECA chapter, a public library pitch night, or a city economic-development contest are all fair game.
2. **Step up to regional or state competitions** once you've placed locally. These are a middle tier — a few hundred teams, real judges, decent prizes.
...
A stack of local and regional wins tells that story better than one national entry you didn't place in. We wrote more on this in [does entrepreneurship help with college applications](/blog/entrepreneurship-extracurricular-college-apps), and if you want to write about it well, [how to write about your startup on college applications](/blog/should-you-put-your-startup-on-your-college-application) is worth a read. The short version: judges and admissions officers both reward the same thing — a founder who did the work, not one who collected logos.
...
- **Read the judging criteria.** Some contests reward a polished business plan document; others reward a live pitch and real traction. If you have users but no formal plan, pick the traction-friendly one. Understand [what judges actually look for](/blog/what-do-startup-judges-look-for) before you write a word.
...
Whatever you enter, the fundamentals are the same. You'll need a tight deck ([the slide order that actually works](/blog/pitch-deck-slide-order-that-works)) and a way to show progress even before you have revenue ([what to put on your traction slide with no revenue](/blog/traction-slide-with-no-revenue)).
