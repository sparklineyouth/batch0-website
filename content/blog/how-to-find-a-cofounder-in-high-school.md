...
category: "Founders"
author: "rishabh"
tags: ["cofounder", "co-founder", "startup team", "finding a cofounder", "teen founders"]
---
...
Here's the honest test. If you need someone to write code and you have three months, you might be better off learning [how to build an MVP with no code](/blog/how-to-build-mvp-no-code-student) than giving away half your company. No-code tools have gotten good enough that "I need a technical co-founder" is often just "I haven't tried yet."
...
There's no shame in going solo. Read [what to do when your first startup fails](/blog/dealing-with-failure-as-a-young-founder) and you'll notice most early failures come from the idea or the follow-through, not from being one person short.
...
A good trial project might be running [customer interviews](/blog/customer-interviews-beginners-guide) together, or building [a landing page that converts](/blog/build-landing-page-that-converts) for an idea you're both curious about. You'll learn more in two weeks of shipping than in months of talking about the dream.
...
You don't need a lawyer or an LLC on day one to have this conversation. A shared document that says who owns what percentage, how it vests, and who decides what is enough to start. If you're curious when the legal stuff actually matters, see [whether you need an LLC as a teen entrepreneur](/blog/do-you-need-an-llc-as-a-teen).
...
While you're deciding, keep moving on the work itself. Read [why you should start a company in high school](/blog/why-start-a-company-in-high-school) if you need the push, and [how to balance school and a startup without burning out](/blog/balancing-school-and-startup) so that whoever you build with, you both make it to the finish line.
