...
category: "Playbook"
author: "team"
tags: ["entrepreneurship club", "start a club", "high school club", "student leadership", "club activities"]
---
...
1. **Meeting 1 — Problems, not ideas.** Everyone writes down three annoying problems in their own life. Best problems win a vote. This is the foundation of [finding a startup problem worth solving](/blog/how-to-find-a-startup-problem-worth-solving).
2. **Meeting 2 — Talk to real people.** Members interview five students about the problem they picked. Teach the basics of a good [customer interview](/blog/customer-interviews-beginners-guide) so they ask questions that get honest answers instead of polite lies.
3. **Meeting 3 — Fake it before you build it.** Members make a one-page landing page describing the product as if it already exists. No code required — here are the [best free no-code tools](/blog/best-no-code-tools-for-students) for exactly this.
...
5. **Meetings 5–8 — Build the smallest version.** Turn the idea into a clickable prototype or a manual service. This is where you learn [what an MVP actually is](/blog/what-is-an-mvp) and build one.
6. **Final meeting — Mini demo day.** Everyone gets three minutes to show what they made. Invite your advisor and a couple of teachers as the audience. Learn how to [pitch an idea as a teenager](/blog/how-to-pitch-startup-idea-as-a-teenager) and end the semester with something to show for it.
...
Give people small titles and real jobs. A co-president who runs meetings when you're out, someone on marketing (posters, Instagram, announcements), someone on events. Ownership keeps people coming. It also means the club survives after you graduate, which is what turns a club into something you can genuinely put on a college application — here's an honest take on whether [entrepreneurship helps with college apps](/blog/entrepreneurship-extracurricular-college-apps).

Give the club a deadline to point at. Clubs drift without a finish line. Pick an external event and aim the whole semester at it — a school demo day you organize, or one of the [best startup competitions for high school students](/blog/best-startup-competitions-for-high-school-students). A real date on the calendar forces real work.
...
If a few of your members catch the bug and want to build a real company across guided sprints, point them to the [batch0 program](/program): it's a live online accelerator where high schoolers build and launch a startup in four two-week sprints and pitch it at a demo day. Applying is [free](/apply), and there's no equity taken, so it's a low-risk way for your strongest members to go further than a weekly club can take them.
