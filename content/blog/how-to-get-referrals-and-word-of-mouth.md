...
So before any tactic: be honest about whether people love your product or just tolerate it. If your users would shrug when it disappeared, no referral trick will save you. Read [why "my friends love it" is not validation](/blog/friends-family-said-they-loved-my-idea) — polite interest and real word of mouth come from different places. Fix the product first.
...
- **It solved a painful problem, right now.** Nobody recommends a vitamin. They recommend the painkiller that stopped the headache. If you're not sure which one you built, read [vitamin or painkiller](/blog/vitamin-vs-painkiller-startup) — it decides whether anyone bothers to mention you.
...
If you're not sure which channel deserves your attention at all, [distribution: how early startups actually find users](/blog/distribution-channels-for-early-startups) and [why you should pick one marketing channel, not ten](/blog/one-channel-vs-many-early-growth) will keep you from spreading yourself thin.
...
One more trap: don't confuse a spike in signups with real traction. A hundred people clicking an invite link means nothing if they vanish in a week. [Do waitlist signups mean your idea is validated?](/blog/waitlist-signups-as-validation) applies here too — retention is what turns word of mouth into a machine instead of a one-time bump.
...
Start by hand. Get your [first 10 customers](/blog/how-to-get-first-10-customers-student-founder) the unscalable way: DM people directly, help them personally, sit with them while they use it. These early users are where word of mouth is born, because you can make them love the product one at a time. Then seed the loop by giving them something worth passing on — early access, a role shaping the product, a "founding user" status. People love being early to something that later gets big.

Then go where your people already gather instead of shouting into the void. [Find where your customers already hang out online](/blog/how-to-find-where-your-customers-hang-out) — the Discord server, the subreddit, the group chat — and let word of mouth travel inside a community that already trusts itself.
