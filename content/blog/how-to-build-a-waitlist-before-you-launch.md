...
The headline is where most people lose. "Introducing StudyBuddy" tells me nothing. "Turn your class notes into practice quizzes in 30 seconds" tells me exactly what I get. Write the headline about the reader's problem, not your product's name. [How to build a landing page that converts](/blog/build-landing-page-that-converts) covers how to write the headline and everything under it.
...
1. **Write down who signs up.** Not "everyone" — the exact person. "Juniors at my school taking AP Bio" is a real answer. "Students" is not.
2. **List five places that person already hangs out.** A specific subreddit, a Discord server, a class group chat, a club, a TikTok niche. Be concrete.
3. **Post where it's allowed, help where it's not.** In communities, don't drop a link and run — you'll get removed. Answer questions, be useful, and share your page when it genuinely fits. [How to launch your startup on Reddit without getting banned](/blog/how-to-launch-on-reddit-without-getting-banned) shows the line.
4. **DM ten people who clearly have the problem.** A short, human message beats a mass blast — help first, ask second.
5. **Ask every signup to send it to one friend.** Word of mouth is the cheapest channel you have. Make it a single sentence in your confirmation email.
...
- **Update them once every week or two.** A two-line note — "here's what we built this week, here's a screenshot" — reminds them you're real and making progress. This is the whole idea behind [building in public as a teen founder](/blog/build-in-public-strategy-for-student-founders).
...
Getting your first hundred subscribers and keeping them isn't a mystery — it's consistency. [How to get your first 100 email subscribers with no audience](/blog/how-to-get-your-first-email-subscribers) covers the acquisition side in more depth.
...
If you'd rather run this loop with structure, deadlines, and people who've done it, that's exactly what the Market sprint inside [the Sparkline program](/program) is built for — you'll go from a page to real signups to a launch in a single focused week. When you're ready, [applying is free](/apply), and you only pay if you're accepted.
