...
You can also chain them: landing page to confirm demand, then a pre-sale to confirm willingness to pay, then concierge to nail the details. That's the focus of the two-week [Validate sprint at batch0](/program), where you run these tests on your own idea with feedback before you build anything.
