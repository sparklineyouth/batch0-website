...
1. **Start with free tools.** Build the first version with no-code and free tiers. See [how to build and run a startup for basically $0](/blog/free-tiers-to-build-a-startup-for-free) and [the best free no-code tools for students](/blog/best-no-code-tools-for-students).
2. **Spend only on things that create proof.** A $12 domain to look legit to your first customers? Fine. A logo designer before anyone's paid you? No.
3. **Let the business pay for itself.** Once one customer pays, that money buys the next thing you need. Now you're not funding it out of allowance anymore.
4. **Skip the LLC until you have to.** You almost certainly don't need one yet — [here's when a teen actually needs an LLC](/blog/do-you-need-an-llc-as-a-teen).

A realistic bootstrap budget for a first startup is $20 to $80 total. If you're not sure where your number lands, work through [what it will actually cost to build your product](/blog/how-to-calculate-cost-to-build-a-product) first — it puts a real figure on domains, hosting, and tools before you spend a dollar. If your plan needs hundreds of dollars before launch, the plan is too expensive — not underfunded.
...
**Grants.** A grant is a gift — you apply, and if you're chosen, you spend it on your business and never pay it back or give up any ownership. Youth business nonprofits, cause-based foundations (climate, mental health, education), and even local credit unions and community foundations hand out awards from a few hundred dollars up to five figures. The famous national ones have thousands of applicants; the small local ones might have a dozen. Chase both. Our full guide is [grants for high school entrepreneurs: where to find free money](/blog/grants-for-high-school-entrepreneurs).

**Competition prizes.** A pitch or business-plan competition is really just a grant you win on a stage instead of on paper. Many are free to enter, most are open to ages 13-18, and the prize is cash with no strings. Start with [the best startup competitions for high school students](/blog/best-startup-competitions-for-high-school-students), then read [how to actually win the prize money](/blog/how-to-win-a-pitch-competition-money) so you're not just showing up. A strong deck matters here — [how to write a pitch deck for a high school competition](/blog/how-to-write-pitch-deck-high-school-competition) walks through it.

Don't overlook two quieter sources. **Free startup credits** — hosting, software, AI tools worth hundreds of dollars — aren't cash, but every dollar of credits is a dollar you don't have to raise; see [how to get free startup credits and perks](/blog/how-to-get-startup-credits-and-perks). And if your startup earns you real money later, some [scholarships for student entrepreneurs](/blog/scholarships-for-student-entrepreneurs) reward you for having built it.
...
The counterintuitive move is to charge *early* — even before the product is fully built. Presales fund the build and validate demand in one shot. If you can get ten people to pay before you've written a line of code, you've solved your funding problem and your "does anyone want this" problem together. Read [how to get people to pay before you build anything](/blog/presell-before-you-build).

A few things make early revenue work:

- **Price it like it's worth something.** Underpricing feels safer but starves you. [How to price your first product](/blog/how-to-price-your-first-product) covers this.
- **Get money-in working even though you're under 18.** You can, with a parent's help. [How to accept payments when you're under 18](/blog/how-to-set-up-payments-for-teen-business) shows the setup.
- **Focus on the first ten customers, not a thousand.** [How to get your first 10 customers as a student founder](/blog/how-to-get-first-10-customers-student-founder) is the whole early game.
...
1. **Validate for free.** Talk to potential customers, run a landing page, confirm the problem is real. Cost: $0.
2. **Bootstrap the minimum.** Buy the domain, use free tools, build a first version. Cost: about $15.
3. **Presell.** Charge your first few customers before the product is finished. This should cover your remaining costs and then some.
4. **Enter two competitions.** Free to enter, cash prizes, and the deck you build is reusable. Apply while the product is live.
5. **Grab your credits and one grant.** Claim free startup credits, and apply to one grant that fits your specific cause.
