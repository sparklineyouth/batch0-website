...
1. **The problem is real.** Not "would be nice to fix." Real means people already spend time, money, or frustration dealing with it right now.
2. **The solution fits.** Your specific idea maps onto that pain closely enough that someone would choose it over their current workaround.
...
A vague "yeah I'd totally use that" is not commitment. It's politeness. The best way to gather these signals is by talking to people directly, which is why [customer interviews are the core skill here](/blog/customer-interviews-beginners-guide) — you're listening for the workarounds and the pain, not pitching your idea.
...
1. **No fit yet.** You have a hunch. Allowed to build: nothing but conversations. Go find the problem and confirm it's real. Start with [how to find a problem worth solving](/blog/how-to-find-a-startup-problem-worth-solving).
2. **Problem confirmed, solution unclear.** People agree the pain is real, but you're not sure your fix is right. Allowed to build: a landing page, a mockup, a fake test. This is exactly [how to test a business idea before building it](/blog/how-to-test-business-idea-before-building).
3. **Solution resonates.** People react to your specific approach and commit something. Allowed to build: a minimum viable product, the smallest thing that delivers the core value. If that term is fuzzy, here's [what an MVP actually is](/blog/what-is-an-mvp).
4. **MVP used and loved.** People use it and come back. Now you're chasing product-market fit, and building bigger is finally justified.
