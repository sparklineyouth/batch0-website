...
Name one problem and the exact person who has it. Make it concrete: not "food waste is a huge issue," but "students who live alone buy groceries for recipes, cook once, and throw out the rest." If you did the work, this is where the pain you heard in real conversations shows up. Weak problem slides come from skipping that work, so read [how to find a startup problem worth solving](/blog/how-to-find-a-startup-problem-worth-solving) before you write this one.
...
2. **Does the solution fit the problem?** A clever product aimed at a fake problem loses to a simple one aimed at a real one. This is [problem-solution fit](/blog/problem-solution-fit-explained), and it's the first thing sharp judges test.
...
5. **Can you handle a hard question?** The Q&A often matters more than the pitch. Prepare for it with [how to answer hard questions in a pitch](/blog/how-to-answer-investor-questions).
...
- **It's not the pitch itself.** You are the pitch. The deck just keeps everyone on the same page while you talk, which is why [how to pitch a startup idea as a teenager](/blog/how-to-pitch-startup-idea-as-a-teenager) matters as much as the file.
