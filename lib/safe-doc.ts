...
export function renderSafeDoc(args: {
  ...
  lines.push(
    ...
    "- This SAFE is **non-voting** — the Investor does not gain board rights, information rights beyond the batch0 investor portal, or veto rights until conversion.",
    "",
    "## Process",
    "",
    ...
    "3. On counter-sign, both parties receive a fully-executed copy via email and batch0 logs the signatures in the audit trail.",
    "",
    "## Important",
    "",
    ...
    "- Confirm dilution math with the batch0 team or an outside advisor.",
    "",
