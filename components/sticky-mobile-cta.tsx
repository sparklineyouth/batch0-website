    ...
    >
      <div className="pointer-events-auto border-t border-line bg-paper px-4 pb-safe pt-3">
        <a
          ...
          className="press flex w-full items-center justify-between gap-3 rounded-md bg-spark px-4 py-3.5 text-[15px] font-semibold text-ink shadow-cta hover:bg-spark-200"
        >
