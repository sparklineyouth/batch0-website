...
/**
 * What you work toward — concrete artifacts, no values-speak. Each item is
...
const DELIVERABLES: { title: string; body: string }[] = [
  ...
  {
    title: "An evidence-based pitch deck",
    body: "A prepared demo or narrated deck for the staff-hosted showcase.",
  },
  {
    ...
    <section className="border-t border-line px-5 py-20 sm:px-6 md:py-28">
      <div className="mx-auto max-w-[1100px]">
        ...
        <p className="mt-4 max-w-[38rem] text-[15px] leading-[1.65] text-ink-soft">
          The work you will build toward, with progress depending on your effort:
        </p>
