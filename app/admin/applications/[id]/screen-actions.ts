...
${app.experience ?? "(blank)"}`;
  ...
  const res = await client.messages.create({
    ...
    system: [
      {
        type: "text",
        text: `You're screening high-school applicants for batch0, a four-sprint startup accelerator. Be honest and direct — admins make the final decision, you're sorting the queue.
