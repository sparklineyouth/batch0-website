          ...
          {moduleRows.map((r) => (
            <li key={r.id} className="px-4 py-3">
              <div className="grid grid-cols-12 items-baseline gap-2">
                <div className="col-span-1 text-xs text-white/60">{r.week}</div>
                ...
                <div className="col-span-2 text-right text-sm tabular-nums text-white/80">
                  {r.comments}
                </div>
                <div className="col-span-2 text-right text-sm tabular-nums text-white/80">
                  {r.questions}
              ...
              {r.recent.length > 0 && (
                <details className="mt-2">
                  <summary className="cursor-pointer text-[11px] uppercase tracking-wider text-white/40 hover:text-white/70">
                  ...
                  <ul className="mt-2 space-y-2 pl-2">
                    {r.recent.map((c, i) => (
                      ...
                      >
                        <p className="text-white/40">{c.lessonTitle}</p>
