...
export const metadata = { title: "Course · SparkLine" };
    ...
    <div className="mx-auto max-w-4xl">
      <div className="flex items-end justify-between">
        ...
        <div className="text-right">
          ...
          <div className="text-2xl font-semibold text-spark">{pct}%</div>
        </div>
      </div>
                ...
                {sortedLessons.map((l: any) => (
                  <li key={l.id}>
                    <Link
                      ...
                      className="flex items-center gap-3 px-6 py-3.5 transition hover:bg-white/5"
                    >
                      {completed.has(l.id) ? (
                        <CheckCircle2 className="h-5 w-5 shrink-0 text-emerald-400" />
                      ) : (
                        <PlayCircle className="h-5 w-5 shrink-0 text-white/40" />
                      )}
